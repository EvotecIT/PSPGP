    ...
    public class CmdletNewPGPKey : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            try
            {
                ...
                {
                    pgp.GenerateKey(resolvedPublic, resolvedPrivate, user, pass, Strength, Certainty, EmitVersion.IsPresent);
                }
                else
                {
                    pgp.GenerateKey(resolvedPublic, resolvedPrivate, user, pass);
                }
            }
            catch (Exception ex)
            {
